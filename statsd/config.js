...
Optional Variables:
  ...
  redis:
    redisCenter:    store ip/api list, only store master redis
    expireTime:     store key/value expire minute default 300
    redis:          [{host:'10.13.80.59',port:6379},{host:'10.13.80.59',port,6379}]
    hashRegPrefix:
