...
var redisMaster={host:'10.13.80.58',port:6379};
var redisCluster=[{host:'10.13.80.58',port:6379},{host:'10.13.80.58',port:6379}];
var redisExpireTime=10;
/*
...
, backend: [ "syslog" ]
, flushInterval: 60000
, backends: [ "./backends/console-redis" ]
, redis: [{host:'10.13.80.58',port:6379},{host:'10.13.80.58',port:6379}]
, redisCenter: {host:'10.13.80.58',port:6379}
, redisExpireTime: 300
*/
function Map() {
...
function flush(timestamp, metrics)
{
    ...
    for( var i=0; i<ipApiMergeList.size();i++){ //item in ipMergeList.elements ){
        ...
        console.log(ipName_temp+":"+ip_value);
    ...
    for( var i=0; i<ipMergeList.size();i++){ //item in ipMergeList.elements ){
        ...
        redisClientObjList[hashIndex].set( ipName_temp, ip_value );
        redisClientObjList[hashIndex].expire( ipName_temp, redisExpireTime );
        redisClientObjList[hashIndex].sadd( "ipKeyList", ipName_temp );
        if ( debug )
    ...
    for( var i=0; i<idcMergeList.size();i++){
        ...
        console.log(idcName_temp+":"+idc_value);
        var hashIndex = getHashIndex( ipName_temp );
        ...
        redisClientObjList[hashIndex].sadd( "idcKeyList", idcName_temp );
        if ( debug )
    ...
    {
	    redisClient = redis.createClient(6379,'10.13.80.58');
        redisClient.rpush('alertQueue', queueNodeData);
	    redisClient.quit();
    }
    redisMasterObj.quit();
...
/*
openapi.coreapi_yf.byhost.10_75_8_151.http_2xx._2_statuses_friends_timeline_json.less_500ms:208
openapi.coreapi_yf.byhost.10_75_8_151.http_2xx._2_statuses_friends_timeline_json.less_1s:8
openapi.coreapi_yf.byhost.10_75_8_151.http_2xx._2_statuses_friends_timeline_json.less_2s:1
*/
var tmp = {counters:{"openapi.coreapi_yf.byhost.10_75_8_151.http_2xx._2_statuses_friends_timeline_json.less_500ms":208,"openapi.coreapi_yf.byhost.10_75_8_151.http_2xx._2_statuses_friends_timeline_json.less_1s":8,"openapi.coreapi_yf.byhost.10_75_8_151.http_2xx._2_statuses_friends_timeline_json.less_2s":1}};
var tmp1 = {counters:{"openapi.coreapi_yf.byhost.10_75_8_151.http_2xx._2_statuses_friends_timeline_json.hits":208,"openapi.coreapi_yf.byhost.10_75_8_151.http_4xx._2_statuses_friends_timeline_json.hits":8,"openapi.coreapi_yf.byhost.10_75_8_151.http_5xx._2_statuses_friends_timeline_json.hits":1}};

console.log(tmp);
console.log("\n\n");
console.log( flush(111,tmp));

console.log("\n\n");
console.log("\n\n");
console.log(tmp1);
console.log("\n\n");
console.log( flush(111,tmp1));
